...
import { selectTopLevelElements, selectZoom, selectPan, selectSelectedIds } from '../store/selectors';
import { deleteSelected, clearSelection, setZoom } from '../store/canvasSlice';
import CanvasElement from './CanvasElement';

export default function Canvas() {
  const dispatch = useAppDispatch();
  const topLevelElements = useAppSelector(selectTopLevelElements);
